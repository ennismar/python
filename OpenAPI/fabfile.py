...
env.roledefs = {
    'remote_server': ['iot@192.168.1.200:22', 'iot444@192.168.1.201:22', 'iot1@192.168.1.202:22'],
}

env.passwords = {
    'iot@192.168.1.200:22': 'iot',
    'iot444@192.168.1.201:22': 'iot444',
    'iot1@192.168.1.202:22': 'iot1',
}

PROJECT_NAME = 'OpenAPI'
SETTING_DIR = '~/OpenAPI/common/'
RELEASE_DIR = '~/serv_release/'
RELEASE_NAME = 'OpenAPI.tar.gz'
